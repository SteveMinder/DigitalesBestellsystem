...
# --------------------------------------------------
# Enthält alle Textübersetzungen für die GUI.
# Unterstützte Sprachen: Deutsch (de), Französisch (fr), Englisch (en)
# Schlüssel sind Deutsch, Werte sind sprachspezifisch.
# --------------------------------------------------
